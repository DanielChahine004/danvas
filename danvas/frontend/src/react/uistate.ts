...
// Which bottom-left flyout chrome is expanded. The graveyard, merge, and hosting
// panels all open upward from the bottom-left corner, so they're mutually
// exclusive — opening one collapses the others, and their panels never overlap.
// null = all collapsed.
export type ChromePanel = 'graveyard' | 'merge' | 'hosting' | null
