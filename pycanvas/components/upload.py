...
The mirror image of :class:`~pycanvas.Download`. The browser holds a file the
...
Rendered as a native React panel (like :class:`~pycanvas.Button`), so it follows
...
class Upload(React):
    ...
    def on_upload(self, fn):
        ...
        :meth:`~pycanvas.bridge.Bridge.resolve_viewer`.
        """
